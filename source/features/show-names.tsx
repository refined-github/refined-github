...
async function updateLink(batchedUsernameElements: HTMLAnchorElement[]): Promise<void> {
	...
	if (usernames.has('undefined')) {
		console.warn('`show-names is currently broken on GitHub Enterprise: https://github.com/refined-github/refined-github/issues/7699', element);
