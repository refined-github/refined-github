...
function onButtonClick(): void {
	const links = $$([
		...
		'a.h4.js-navigation-open', // TODO [2026-01-01]: Pre-React selector; Drop in 2026
	]);
	...
	const selectedLinks = links.filter(link =>
		$closestOptional([
			'.js-issue-row.selected', // TODO [2026-01-01]: Pre-React selector; Drop in 2026
			'[aria-label^="Selected"]',
		], link),
	);
...
const multipleConversationsSelector = [
	'.js-issue-row + .js-issue-row', // TODO [2026-01-01]: Pre-React selector; Drop in 2026
...
function add(anchor: HTMLElement): void {
	...
	const isSelected = $closestOptional([
		'.table-list-triage', // TODO [2026-01-01]: Pre-React selector; Drop in 2026
...
async function init(signal: AbortSignal): Promise<void | false> {
	observe(
		[
			'.table-list-header-toggle:not(.states)', // TODO [2026-01-01]: Pre-React selector; Drop in 2026
