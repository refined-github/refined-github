...
const hasNotificationBar = (): boolean =>
	...
	JSON.parse(sessionStorage.getItem('notification_shelf') ?? '{}').pathname ===
		location.pathname;
...
function handleClick(
	...
	const redirectDisabled =
		event.altKey || sessionStorage.rghIsNewTab === 'true';
	event.delegateTarget.form!.toggleAttribute(
		'data-redirect-to-inbox-on-submit',
		!redirectDisabled,
	);
}
...
function init(signal: AbortSignal): void {
	...
	delegate(
		'.notification-shelf .js-notification-action button',
		'click',
		handleClick,
		{signal},
	);
