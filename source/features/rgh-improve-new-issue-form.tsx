...
function addTokenNotice(adjective: string): void {
	addNotice(
		...
		<>
			<p>
				Your token is {adjective}. Many Rough GitHub features don't work without it.
...
function addVersionNotice(releaseAgeInDays: number): void {
	addNotice(
		'warn',
		<p>
			Your Rough GitHub version is {releaseAgeInDays} days old. <a href="https://github.com/refined-github/refined-github#install">A newer version may be available.</a>
		</p>,
	);
}
