...
function init(): void {
	for (const link of $$('.js-issue-row a[aria-label*="comment"], .js-pinned-issue-list-item a[aria-label*="comment"]')) {
...
function initDashboard(): void {
	observe('.js-recent-activity-container :not(a) > div > .octicon-comment', {
		add(icon) {
			const url = icon.closest('li')!.$('a')!.pathname + '#partial-timeline';
