...
function addToConversation(discussionHeader: HTMLElement): void {
	...
	wrap(discussionHeader, <a aria-label="Scroll to most recent close event" className="tooltipped tooltipped-s" href={'#' + getLastCloseEvent()!.id} />);
}

function init(signal: AbortSignal): void {
	observe(closedOrMergedMarkerSelector, addToConversation, {signal});
}

void features.add(import.meta.url, {
	asLongAs: [pageDetect.isConversation],
	include: [pageDetect.isClosedIssue, pageDetect.isClosedPR],
