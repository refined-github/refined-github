...
function init(): void {
	...
	lastNotificationPageNode.replaceWith(<> of <a style={{textDecoration: 'underline'}} className="rgh-last-notification-page-button" href={nextButtonURL.href}>{lastNotificationPageNumber}</a></>);
}
