...
function init(): void | false {
	...
	const headReference = select('.head-ref')!;
	const repoIsDeleted = headReference.textContent === 'unknown repository';
	const repoRootUrl = select('a', headReference)?.href.split('/', 5).join('/');
