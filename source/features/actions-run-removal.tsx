...
function addQuickButtons(contextMenuIcon: HTMLElement): void {
	...
	// eslint-disable-next-line @typescript-eslint/no-unnecessary-type-arguments, no-restricted-syntax -- Wrong; Element may not exist, using $optional intentionally
