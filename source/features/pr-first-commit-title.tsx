...
function init(signal: AbortSignal): void {
	observe("#commits_bucket > :first-child .js-commits-list-item:first-child p", useCommitTitle, {
		signal,
	});
}
...
void features.add(import.meta.url, {
	...
	exclude: [() => new URLSearchParams(location.search).has("title"), hasUserAlteredThePr],
	init,
});
