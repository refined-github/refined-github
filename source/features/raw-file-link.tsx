...
features.add({
	id: 'raw-file-link',
	description: 'View a raw version of files in pull requests and commits (https://user-images.githubusercontent.com/1402241/56484988-b99f2500-6504-11e9-9748-c944e1070cc8.png)',
	include: [
		features.isCommit,
		features.isPRFiles
	],
