...
function init(): void {
    ...
    document.querySelectorAll(".diff-table").forEach(element => {
        const callback = () => {
            const btns = element.querySelectorAll(".js-expand.directional-expander.single-expander")
    ...
    document.querySelectorAll(".js-expand.directional-expander.single-expander").forEach(element => {
...
features.add({
	...
	screenshot: '',
	include: [
	 features.isPRCommit, features.isSingleCommit
	],
