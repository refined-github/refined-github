...
void features.add({
	id: __filebasename,
	description: 'After you click on an ajaxed link, this lets you stop loading a page by pressing the <kbd>esc</kbd> key, like the browser does for regular page loads',
