...
async function fetchDom<TElement extends Element>(url: string, selector: string, ...options: any[]): Promise<TElement | undefined>;
async function fetchDom(url: string, selector?: string, ...options: any[]): Promise<Node | undefined> {
