...
export const privateLockFilled = () =>
	<svg version="1.1" viewBox="-118 118 12 16" width="12" height="16">
		<g>
			<path fill="#eee" d="M-109.8,122c0-1.2-1-2.2-2.2-2.2c-1.2,0-2.2,1-2.2,2.2v2h4.4V122z"/>
			<path fill="#eee" d="M-116,132h9v-7h-9V132z M-115,126h1v1h-1V126z M-115,128h1v1h-1V128z M-115,130h1v1h-1V130z"/>
			<path fill="#333" d="M-107,124h-1v-2c0-2.2-1.8-4-4-4s-4,1.8-4,4v2h-1c-0.5,0-1,0.5-1,1v7c0,0.5,0.5,1,1,1h10c0.5,0,1-0.5,1-1v-7
					C-106,124.5-106.5,124-107,124z M-114.2,122c0-1.2,1-2.2,2.2-2.2c1.2,0,2.2,1,2.2,2.2v2h-4.4V122z M-107,132h-9v-7h9V132z"/>
			<rect x="-115" y="130" width="1" height="1"/>
			<rect x="-115" y="126" width="1" height="1"/>
			<rect x="-115" y="128" width="1" height="1"/>
		</g>
	</svg>;
