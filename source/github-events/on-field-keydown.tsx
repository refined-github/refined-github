...
type DelegateFieldEvent = DelegateEventHandler<
	KeyboardEvent,
	HTMLTextAreaElement
>;
...
export function onCommentFieldKeydown(
	callback: DelegateFieldEvent,
	signal: AbortSignal,
): void {
...
export function onConversationTitleFieldKeydown(
	callback: DelegateFieldEvent,
	signal: AbortSignal,
): void {
	onFieldKeydown(
		'input[placeholder="Title"], #issue_title, #pull_request_title',
		callback,
		signal,
	);
}

export function onCommitTitleFieldKeydown(
	callback: DelegateFieldEvent,
	signal: AbortSignal,
): void {
