...
export function createFragmentLoadListener(fragmentSelector: string, callback: EventListener): delegate.Subscription {
...
export default function onDiffFileLoad(callback: EventListener): delegate.Subscription {
	return createFragmentLoadListener(fragmentSelector, callback);
}
