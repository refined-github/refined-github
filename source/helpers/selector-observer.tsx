...
const getListener =
	<Selector extends string, ExpectedElement extends ParseSelector<Selector, HTMLElement | SVGElement>>(
		seenMark: string,
		selector: Selector,
...
export default function observe<Selector extends string, ExpectedElement extends ParseSelector<Selector, HTMLElement | SVGElement>>(
