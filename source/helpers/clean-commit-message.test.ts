...
test('cleanCommitMessage', () => {
	const coauthors = ['Co-authored-by: Me <me@example.com>', 'co-authored-by: Me <me@example.com>', 'Co-authored-by: You <you@example.com>'];
	...
	`,
		...
		[coauthors[0], 'Fixes #1', 'closes https://github.com/refined-github/refined-github/pull/6328'].join('\n'),
