...
async function fetchDom<Selector extends string, ElementType extends HTMLElement = ParseSelector<Selector, HTMLElement>>(url: string, selector: Selector): Promise<ElementType | undefined>;
