...
test('getConversationNumber', () => {
	const pairs = new Map<string, number | undefined>([
		...
		['https://github.com/refined-github/refined-github/', undefined],
		['https://github.com/refined-github/refined-github/blame/main/package.json', undefined],
		['https://github.com/refined-github/refined-github/commit/57bf4', undefined],
		['https://github.com/refined-github/refined-github/compare/test-branch?quick_pull=0', undefined],
		['https://github.com/refined-github/refined-github/tree/main/distribution', undefined],
		['https://github.com/refined-github/refined-github/pull/148/commits/0019603b83bd97c2f7ef240969f49e6126c5ec85', 148],
		['https://github.com/refined-github/refined-github/pull/148/commits/00196', 148],
...
test('getLatestVersionTag', () => {
	assert.equal(getLatestVersionTag(['0.0.0', 'v1.1', 'r2.0', '3.0']), '3.0', 'Tags should be sorted by version');

	assert.equal(getLatestVersionTag(['v2.1-0', 'v2.0', 'r1.5.5', 'r1.0', 'v1.0-1']), 'v2.0', 'Prereleases should be ignored');

	assert.equal(getLatestVersionTag(['lol v0.0.0', '2.0', '2020-10-10', 'v1.0-1']), 'lol v0.0.0', 'Non-version tags should short-circuit the sorting and return the first tag');
});
