...
test('preventPrCommitLinkLoss', () => {
	...
	assert.equal(
		replacePrCommitLink('https://www.google.com/'),
...
test('preventDiscussionLinkLoss', () => {
	...
	assert.equal(
		replaceDiscussionLink(
			'https://github.com/eslint/eslint/discussions/15898?sort=top#discussion-4086661',
		),
		'[eslint/eslint#15898 (comment)](https://github.com/eslint/eslint/discussions/15898?sort=top#discussion-4086661)',
	);
	assert.equal(
		replaceDiscussionLink(
			'https://github.com/eslint/eslint/discussions/15898?sort=top#issue-comment-box',
		),
