...
- [](# "keyboard-navigation") Adds shortcuts to comments: <kbd>j</kbd> focuses the comment below; <kbd>k</kbd> focuses comment above; <kbd>e</kbd> edits the focused comment; <kbd>d</kbd> deletes the focused comment.
