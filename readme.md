...
- [](# "update-pr-from-base-branch") [Adds an "Update branch | Rebase" button to every PR.](https://github.com/user-attachments/assets/19f2ee95-1903-40a7-a7be-6c5d27d2fef9) GitHub has the same feature, but it must be manually configured for each repo.
