...
- [](# "repo-wide-file-finder") The <kbd>t</kbd> file finder works on the `Issues` and `Pull Requests` tabs as well.
- [](# "file-finder-buffer") While invoking the file finder, keystrokes pressed immediately following the <kbd>t</kbd> are captured and populated in the search field.
- [](# "preserve-file-finder-term") [The search term is preserved across multiple invocations of the <kbd>t</kbd> file finder](https://user-images.githubusercontent.com/1402241/75542106-1c811700-5a5a-11ea-8aa5-bea0472c59e2.gif)
