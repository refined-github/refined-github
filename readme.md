...
- [](# "pagination-hotkey") Adds shortcuts to navigate through pages with pagination: <kbd>p</kbd> and <kbd>n</kbd>. On repository issues and pull requests lists, the shortcuts are <kbd>←</kbd> and <kbd>→</kbd>.
