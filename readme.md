...
- **Edge** extension: Follow [this guide](https://support.microsoft.com/en-us/help/4538971/microsoft-edge-add-or-remove-extensions) to install the Chrome version (only applicable to Chromium-based Edge).
