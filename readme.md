...
<table>
	<tr>
		...
		<th width="50%">
			Add link to an issue’s closing commit or pull request
		</th>
	</tr>
	<tr><!-- Prevent zebra stripes --></tr>
	<tr>
...
- <!-- make-discussion-sidebar-sticky --> [Makes the discussion filters bar sticky.](https://user-images.githubusercontent.com/380914/39878141-7632e61a-542c-11e8-9c66-74fcd3a134aa.gif)
...
- <!-- revert-file --> [Adds button to revert all the changes to a file in a PR.](https://user-images.githubusercontent.com/1402241/60279449-a610a000-9933-11e9-8b40-fe8b935dc7ad.gif)
