...
- [](# "collapse-markdown-sections") [Wraps the main sections of Markdown files in <details> elements to make the collapsable, and toggles all sections by `Alt`-clicking.](TODO)
