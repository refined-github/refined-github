...
- [](# "search-results-in-new-tab") Makes search dialog results open in a new tab via middle click, and keeps the dropdown open when opening a result in a new tab.
