...
- [](# "patch-diff-links") [Adds links to `.patch` and `.diff` files in PR page's Code dropdown.](https://github.com/user-attachments/assets/e4e02aba-c81c-42db-97ba-3efcd64bc4cd)
