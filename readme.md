...
- [](# "update-pr-from-base-branch") [Adds an "Update branch | Rebase" button to every PR.](https://github.com/user-attachments/assets/8a9d752f-a521-48f1-b12b-afaa3cf0a388) GitHub has the same feature, but it must be manually configured for each repo.
