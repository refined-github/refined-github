/* globals gitHubInjection, pageDetect, diffFileHeader, addReactionParticipants, addFileCopyButton, CodeMirror*/
...
$(document).on('focusin', event => {
	...
	myCodeMirror = CodeMirror.fromTextArea(event.target);
